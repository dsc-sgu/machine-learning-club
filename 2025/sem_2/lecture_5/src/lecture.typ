...
#set document(
  title: [Основные архитектуры CNN],
...
#show: template(
  ...
  header-center: [Основные архитектуры CNN],
  footer-right: [_&&_],
  font: "Cantarell",
)
...
#include "chapters/alex.typ"
#include "chapters/vgg.typ"
#include "chapters/resnet.typ"
#include "chapters/unet.typ"
